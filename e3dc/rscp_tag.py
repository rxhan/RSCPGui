...
class RSCPTag(Enum):
    ...
    SERVER_CUSTOM_START = 0x00000009
    SERVER_CUSTOM_ANSWER = 0x800009
    ...
    RSCP_REQ_SUPPORTED_PROTOCOL_VERSIONS = 0x00000010
    RSCP_SUPPORTED_PROTOCOL_VERSIONS = 8388618
    RSCP_UNKNOWN_1 = 8388624
    ...
    # Unbekannter Tag, seid 2023_06 bei EMS-Abfragen dabei
    ...
    PVI_UNKNOWN1 = 34257925         # Rückgabewert bei Anfrage von PVI_VERSION
